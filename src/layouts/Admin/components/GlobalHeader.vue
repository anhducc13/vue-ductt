  ...
  <a-layout-header :class="[theme, 'global-header']">
    <div :class="['global-header-wide', layout]">
      <router-link v-if="isMobile || layout === 'head'" to="/" :class="['logo', isMobile ? null : 'pc', theme]">
        <img width="32" src="https://iczer.gitee.io/vue-antd-pro/static/img/vue-antd-logo.png" />
      ...
      <div :class="['global-header-right', theme]">
          <header-search v-if="!isMobile" class="header-item" />
...
import IMenu from '@/components/shared/menu/menu'
